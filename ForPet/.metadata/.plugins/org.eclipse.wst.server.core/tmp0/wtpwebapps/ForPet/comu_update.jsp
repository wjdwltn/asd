...
<main class="form-signin w-25" style="margin-left:400px; margin-top:70px;">
	<form style="width:680px;"  method="post" action="comu_updateAction.jsp?idx=<%=idx%>" enctype="multipart/form-data">
	 ...
	 <br>
	  ...
	  <div class="row mb-3">
	    ...
	    <div class="col-sm-10">
	      <input type="text" class="form-control" name="c_title" value="<%=community.getC_title()%>">
	    </div>
	  </div>
	  <div class="row mb-3">
	    <label for="exampleFormControlTextarea1" class="col-sm-2 col-form-label fw-bolder"><span style="color:red;">*</span> 상세설명</label>
	    <div class="col-sm-10">
	      <textarea class="form-control" name="c_content" rows="7"><%=community.getC_content()%></textarea>
	    </div>
	  </div>
	  <div class="row mb-3">
	    <label for="exampleFormControlTextarea1" class="col-sm-2 col-form-label fw-bolder"> 사진업로드</label>
	    <div class="col-sm-10">
	       <input type="file" class="form-control"  name="c_pic" <%=community.getC_pic()%>>
	    </div>
	  </div>
	 <button class="w-100 btn btn-lg btn-primary" style="margin-top:20px;" type="submit">수정하기</button>
	</form>
</main>
