...
<main class="form-signin w-25" style="margin:150px auto!important;">
  <form method="post" action="joinAction.jsp">
    ...
    <div class="form-floating" style="margin-top:5px;">
      <input type="text" class="form-control" name="userName" placeholder="비밀번호">
      <label for="floatingPassword">이름</label>
    </div>
    <div class="form-floating" style="margin-top:5px;">
      <input type="password" class="form-control" name="userPhone" placeholder="비밀번호">
      <label for="floatingPassword">연락처</label>
    </div>
    <div class="form-floating" style="margin-top:5px;">
      <input type="date" class="form-control" name="userDate" placeholder="비밀번호">
      <label for="floatingPassword">생년월일</label>
    </div>

    
    <button class="w-100 btn btn-lg btn-primary" style="margin-top:20px;" type="submit">회원가입</button>
